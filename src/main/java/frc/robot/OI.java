...
//     public static final XboxController controller =
...
//         new Control(
//             XboxController.Axis.kLeftTrigger, "Uses Trigger axis to run scorer", controller,
// 0.1);
...
//         new Control(XboxController.Button.kLeftBumper, "The robot unscores the coral.",
// controller);
...
//     // Start, End & Left/Right stick buttons
//     public static final Control Start = new Control(XboxController.Button.kStart, null,
// controller);
...
//     public static final Control Back = new Control(XboxController.Button.kBack, null,
// controller);
...
//     public static final Control Comma = new Control(2, null, null, keyboard2,
// ControlType.BUTTON);
//     public static final Control Period = new Control(3, null, null, keyboard2,
// ControlType.BUTTON);
...
//         streamDeckButtons[0][i] = new Control(i + 1, null, null, streamDeck1,
// ControlType.BUTTON);
//         streamDeckButtons[1][i] = new Control(i + 1, null, null, streamDeck2,
// ControlType.BUTTON);
//       }
//     }
//   }
